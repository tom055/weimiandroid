...
public class MyChatView extends View{
    ...
    private void drawCycle(Canvas canvas) {
        ...
        for (int i = 0; i < strPercent.length; i++) {
            ...
            sweepPercent = strPercent[i] * 180 / 100;
            canvas.drawArc(new RectF(0, 20, mRadius, mRadius), startPercent, sweepPercent, false, cyclePaint);
        }
    }
