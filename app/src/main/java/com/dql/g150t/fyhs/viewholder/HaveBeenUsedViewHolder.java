...
public class HaveBeenUsedViewHolder extends BaseViewHolder<RedBean>{
    private TextView tv_apr,tv_type,tv_day,tv_money,tv_limit_day;
    public HaveBeenUsedViewHolder(ViewGroup parent) {
        super(parent, R.layout.item_have_been_used);
        tv_apr = $(R.id.tv_apr);
